...
This is a project to simplify the process of deploying Kubeflow (along with the underlying technologies like Tensorflow) onto any underlying Kubernetes platform
