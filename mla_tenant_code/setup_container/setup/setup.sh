...
helm install stable/nfs-server-provisioner --generate-name --set=persistence.enabled=true --set=persistence.storageClass=standard --set=persistence.size=200Gi #--set=storageClass.defaultClass=true
